...
connection = pymysql.connect(host="localhost", user="root", port=3306, password="tP_kc8mn")
...
def get_next_page(url):
    ...
    if response.status_code == 200:
        ...
        for pl in product_list:
            ...
            product_price = re.match(regex, pl.xpath(".//div[@class='Nx9bqj']/text()").get(''))
            product_mrp = re.match(regex, "".join((pl.xpath(".//div[@class='yRaY8j']/text()")).getall()))
