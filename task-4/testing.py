...
def process_product(link):
    ...
    if response.status_code == 200:
        ...
        try:
            cut_size = product_details_json['props']['pageProps']['product']['productSectionMarketingDetails'][
                'cutSize']
        ...
        try:
            pack_size = product_details_json['props']['pageProps']['product']['productSectionMarketingDetails'][
                'casePackDescription']
        except:
            pack_size = ''
        ...
        try:
            ...
            product_details_json['props']['pageProps']['product']['productSectionMarketingDetails'][
                'generalDescription']
        except:
            product_descriptions = ''
        ...
        try:
            ...
            product_details_json['props']['pageProps']['product']['productSectionSpecifications']['grossWeight']
        except:
            product_gross_weight = ''

        try:
            product_net_weight = product_details_json['props']['pageProps']['product']['productSectionSpecifications'][
                'netWeight']
        except:
            product_net_weight = ''
        ...
        try:
            ...
            product_details_json['props']['pageProps']['product']['productSectionSpecifications']['manufactureCountry']
        except:
            product_manufactureCountry = ''

        try:

            product_benefits = "|".join(
                product_details_json['props']['pageProps']['product']['productSectionMarketingDetails']['benefits'])
        ...
        try:
            shipping_storage_width = \
            product_details_json['props']['pageProps']['product']['productSectionShippingStorage']['width']
            shipping_storage_width_uom = shipping_storage_width + product_details_json['props']['pageProps']['product'][
                'productSectionShippingStorage']['widthUoM']

        except:
            shipping_storage_width_uom = ''

        try:
            shipping_storage_length = \
            product_details_json['props']['pageProps']['product']['productSectionShippingStorage']['length']
            shipping_storage_length_uom = shipping_storage_length + \
                                          product_details_json['props']['pageProps']['product'][
                                              'productSectionShippingStorage']['lengthUoM']

        except:
            shipping_storage_length_uom = ''

        try:
            shipping_storage_height = \
            product_details_json['props']['pageProps']['product']['productSectionShippingStorage']['height']
            shipping_storage_height_uom = shipping_storage_height + \
                                          product_details_json['props']['pageProps']['product'][
                                              'productSectionShippingStorage']['heightUoM']
        ...
        try:
            ...
            product_details_json['props']['pageProps']['product']['productSectionShippingStorage']['caseCube']
        ...
        try:
            ...
            product_details_json['props']['pageProps']['product']['productSectionShippingStorage']['tixHi']
        ...
        try:
            ...
            product_details_json['props']['pageProps']['product']['productSectionShippingStorage']['shelfLife']
        ...
        try:
            ...
            product_details_json['props']['pageProps']['product']['productSectionShippingStorage']['storageTempHigh']
            shipping_storage_storageTempHigh_uom = shipping_storage_storageTempHigh + '°' + \
                                                   product_details_json['props']['pageProps']['product'][
                                                       'productSectionShippingStorage']['storageTempUoM']
        ...
        try:
            ...
            product_details_json['props']['pageProps']['product']['productSectionShippingStorage']['storageTempLow']
            shipping_storage_storageTempLow_uom = shipping_storage_storageTempLow + '°' + \
                                                  product_details_json['props']['pageProps']['product'][
                                                      'productSectionShippingStorage']['storageTempUoM']
        ...
        try:
            preparation1 = product_details_json['props']['pageProps']['product']['productSectionPreparation'][
                'description']
        except:
            shipping_storage_shelfLife = ''
        ...
        preparation = []
        try:
            for i in product_details_json['props']['pageProps']['product']['productSectionPreparation'][
                'prepInstructionsCollection']['items']:
        ...
        for pre in preparation:
            try:
                for bullet in product_details_json['props']['pageProps']['product']['productSectionPreparation'][
                    'prepInstructionsCollection']['items']:
        ...
        try:
            ...
            product_details_json['props']['pageProps']['product']['productSectionIngredientsNutrition']['ingredients']
        ...
        hashid = str(
            int(hashlib.md5(bytes(str(category) + str(sub_categorys) + str(title) + str(product_url) + str(sku),
                                  "utf8")).hexdigest(),
                32) % (
                    10 ** 32))
...
def main():
    fetch_links = collection_product_link.find({})
    threads = []
    for link in fetch_links:
        thread = threading.Thread(target=process_product, args=(link,))
